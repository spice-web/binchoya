  ...
  <div class="footer__inner">
    <div class="footer__head">
      ...
      <ul class="footer__sns">
        ...
        <li><a href="/contact"><img src="./images/icon/mail.webp" alt="お問い合わせ" width="auto" height="19.24"></a></li>
      </ul>
    </div>
    <dl class="footer__info">
      <dt>［住&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;所］</dt>
      <dd>〒734-0001 広島県広島市南区出汐3-10-4  </dd>
      <dt>［営業時間］</dt>
      <dd>
        <ul>
          <li>ランチ：11：30～13:30  </li>
          <li>（月、水、木、金）</li>
          <li>ディナー：18：00～22:30 </li>
          <li>（ラストオーダー）</li>
        </ul>
      </dd>
      <dt>［定 休 日］</dt>
    ...
    <div class="footer__button no-deco">
      <a href="/contact"><span class="--tel">お問い合わせ</span></a>
      <a href="/shop" target="_blank" rel="noreferrer noopener"><span class="--webshop">ウェブショップ</span></a>
    </div>
  </footer>
