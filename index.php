...
<main class="wrap__main">
  <div class="container --lg introduction">
    <h2 class="txt-center txt-lg catch"><span>笑顔と真心を<br>料理に込めて</span></h2>
  ...
  <div class="bg-orange pats">
    <div class="container noren">
      <h2 class="food_index--lh-lv2">絶品！博多の“うまかもん”を<br class="br--dis-md" />ご堪能ください！</h2>
      ...
      $items = [
        ...
        ['003', '003nuiki', 'ラーメン', '“締めのラーメン”がメニューになった<span class="nowrap">ラーメン専門店に引けを取らない</span><br />本格的な鶏白湯ラーメン！'],
      ];
      ?>
      <?php foreach ($items as $value) : ?>
        <figure class="food_index --<?= $value[0]; ?>">
          <img src="/images/index/<?= $value[1]; ?>.webp" alt="<?= $value[2]; ?>" width="100%" height="auto">
          <figcaption class="text"><?= $value[3]; ?></figcaption>
        </figure>
      <?php endforeach; ?>
    </div>
  </div>
  ...
  <div class="container career">
    ...
    <div class="career__box">
      <div class="career__textBox">
        ...
        <p class="text ls-100">1959年広島県出身。家業が営む精肉店で25年間働き、TV番組を見たことをきっかけに、博多の串焼き店「まさかど」の店主 諌山雅裕氏に弟子入り。<br>2003年、横川に「博多串焼き びんちょうや」をオープン。2013年、「博多うまかもん びんちょうや」をオープン。<br>経験から導き出した、丁寧な鶏ガラの下処理と、妥協なく煮込むことで、とんこつのように濃厚な…でも、あっさりとした風味の、老若男女に好まれる鶏白湯スープを実現。柚子胡椒を入れて、さらに香り豊かな風味もお楽しみいただけます。</p>
      </div>
